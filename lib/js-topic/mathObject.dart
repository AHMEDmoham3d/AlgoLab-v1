...
class MathObjectPage extends StatefulWidget {
  const MathObjectPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MathObjectPageState createState() => _MathObjectPageState();
}

class _MathObjectPageState extends State<MathObjectPage> {
