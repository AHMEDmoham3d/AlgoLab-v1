...
class _ListPageState extends State<ListPage> {
  List<Map<String, dynamic>> questions = [
    {
      "question":
          "Find the bug in the following function for adding an element to the end of a linked list:\n\n"
              "```dart\n"
    ...
    {
      "question": "Identify the issue in this function:\n\n"
          "```dart\n"
          "void addToEnd(Node head, int value) {\n"
          "  Node newNode = Node(value);\n"
          "  if (head == null) {\n"
    ...
    {
      "question": "What is the error in this implementation?\n\n"
          "```dart\n"
          "void addToEnd(Node head, int value) {\n"
          "  Node newNode = Node(value);\n"
          "  Node temp = head;\n"
    ...
    {
      "question": "Find the mistake in this function:\n\n"
          "```dart\n"
          "void addToEnd(Node head, int value) {\n"
          "  Node newNode = Node(value);\n"
          "  if (head == null) {\n"
    ...
    {
      "question": "Identify the logical error in the following function:\n\n"
          "```dart\n"
          "void addToEnd(Node head, int value) {\n"
          "  Node newNode = Node(value);\n"
          "  if (head == null) {\n"
    ...
    {
      "question": "What is the issue in this function implementation?\n\n"
          "```dart\n"
          "void addToEnd(Node head, int value) {\n"
          "  Node newNode = Node(value);\n"
          "  Node temp = head;\n"
    ...
    {
      "question": "What is the error in this function for inserting a node?\n\n"
          "```dart\n"
          "void addToEnd(Node head, int value) {\n"
          "  Node newNode = Node(value);\n"
          "  Node temp = head;\n"
